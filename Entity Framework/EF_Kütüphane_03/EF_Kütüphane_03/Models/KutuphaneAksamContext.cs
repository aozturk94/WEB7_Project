...
namespace EF_Kütüphane_03.Models
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-MTU4EKB\\SQLEXPRESS; Database=KutuphaneAksam; User=sa; Pwd=123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kitaplar>(entity =>
            {
                entity.HasKey(e => e.Isbn)
                    .HasName("PK__Kitaplar__447D36EBAA30802C");
            ...
            modelBuilder.Entity<Turler>(entity =>
            {
                ...
                entity.HasIndex(e => e.TurAd, "UQ__Turler__A1D0193D2B0FD4DB")
                    .IsUnique();
            ...
            modelBuilder.Entity<Yayinevleri>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ad, "UQ__Yayinevl__3214AD00E904AA0D")
                    .IsUnique();
