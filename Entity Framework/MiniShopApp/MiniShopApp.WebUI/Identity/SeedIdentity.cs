...
namespace MiniShopApp.WebUI.Identity
{
    public static class SeedIdentity
    {
        public static async Task Seed(UserManager<User> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration)
        {
            ...
            var userUserName = configuration["UserData:CostumerUser:UserName"];
            var userEmail = configuration["UserData:CostumerUser:Email"];
            var userPassword = configuration["UserData:CostumerUser:Password"];
            var userRole = configuration["UserData:CostumerUser:Role"];
